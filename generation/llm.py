...
def generate(
    ...
    QUALITY: long-function-justification - prompt assembly, request logging, Ollama
    dispatch, error logging, latency logging, and response extraction are one
    observable generation operation.
    """
